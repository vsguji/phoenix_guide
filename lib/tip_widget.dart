...
/// 默认的引导组件包含，强和弱两种交互模式
class TipInfoWidget extends StatelessWidget {
  /// 引导组件的方向
          ...
          Container(
            ...
            child: CustomPaint(
              ...
              painter: CustomTrianglePainter(
                direction: GuideTipDirection.top,
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: CustomPaint(
              ...
              painter: CustomTrianglePainter(
                  borderColor: borderColor,
                  direction: GuideTipDirection.bottom),
            ),
          ),
        ],
      );
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: CustomPaint(
              ...
              painter: CustomTrianglePainter(
                  borderColor: borderColor, direction: GuideTipDirection.right),
            ),
          ),
        ],
      );
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: CustomPaint(
              ...
              painter: CustomTrianglePainter(
                direction: GuideTipDirection.left,
                borderColor: borderColor,
              ),
            ),
          ),
